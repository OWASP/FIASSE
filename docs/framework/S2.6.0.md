...
Each SSEM attribute is demonstrated through transparency in some form. Note that transparency operates within the bounds set by Confidentiality: visibility is extended only to authorized parties.
