...
I write code so that I can understand it ([Analyzability](../framework/S3.2.1.md#3211-analyzability)) when I come back later to make changes. I make sure there that there are no [hidden side effects](../framework/S2.6.0.md). I write code so that I am confident that I can make changes later without negative sideeffect ([Modifiability](../framework/S3.2.1.md#3212-modifiability)). I prove my code with Unit Tests that cover normal and abnormal values and states. I expect manual assurance tests to prove it as well. ([Testability](../framework/S3.2.1.md#3213-testability)) If I choose to use [open source libraries](../framework/S4.5.0.md), I make sure they fit these values too.

I know that I am not chasing a [static state of secure](../framework/S2.1.0.md). I am building software that is defensible as things change. I build knowing that there will be failures. I build so that failures are less likely to expose sensitive information. When things go wrong, I will need to be able to tell what caused the failure.
